...
from coloriage_lot2.export import export_result
from coloriage_lot2.pipeline import PipelineConfig, run_pipeline
...
class PipelineTests(unittest.TestCase):
    def test_pipeline_merges_and_exports_expected_files(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertEqual(stats["schema_version"], "2.0")
            self.assertEqual(
